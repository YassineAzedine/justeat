        ...
        <div class="col-sm-12 col-md-10 col-md-offset-1">
            <table class="table table-hover">
              ...
              <tr>
                ...
                <div class="media">
                    <a class="thumbnail pull-left" href="#"> <img class="media-object" src="{{$basket->product->image_name}}" style="width: 72px; height: 72px;"> </a>
              ...
              @endforeach
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="{{route('checkout.index')}}" type="button" class="btn btn-success">
